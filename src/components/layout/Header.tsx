    ...
    return(
        <header>
            <div className="text-center text-blue-950 font-serif bg-white sm:text-left">
                ...
                <p className="text-sm mt-4 ml-5 mr-5 sm:text-left sm:ml-6 sm:mr-80 md:mr-96 lg:mt-9 lg:ml-20 xl:ml-32"> 
                    Where code meets creativity: crafting digital Frontend excellence, one pixel at a time.</p>
            </div>
            <div>
                <button className="bg-red-500 hover:bg-red-600 text-white font-serif ml-24 mt-8 mb-16 w-28 h-8
            ...
            <div>
                ...
                <span className="block w-16 h-0.5 bg-red-500 mt-7 ml-24 sm:ml-64 md:ml-80 lg:ml-[450px] xl:ml-[620px]">
                </span></p>


                <h1 className="font-serif text-xl text-blue-950 ml-5 mr-5 mt-14 sm:text-2xl sm:mt-16 lg:ml-20 lg:text-3xl xl:ml-32"> 
            ...
            <div className="font-serif text-xl text-blue-950 mt-9 mb-20"> 
                ...
                <div className="font-serif text-xl text-blue-950">
                    <h1 className="text-xl ml-5 sm:text-2xl lg:text-3xl lg:ml-20 xl:ml-32"> Projects 
                    <span className="block w-11 h-0.5 bg-red-500 mt-2 ml-2"></span>   
                    </h1>
