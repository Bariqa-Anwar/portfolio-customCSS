...
export default function Footer(){
    return(
        <footer className="bg-blue-950 text-white h-72">
            ...
            <div className="flex gap-5 ml-20 sm:gap-9 sm:ml-64 md:ml-80 lg:ml-[450px] xl:ml-[590px]">
            ...
            <div className="mt-16 ml-6 sm:text-center xl:mr-12">
                <h1 className="text-xl font-semibold mb-3 md:text-2xl md:font-serif lg:text-3xl"> 
                Bariqa Anwar 
                <span className="block w-28 h-0.5 bg-red-500 sm:ml-60 md:mx-auto md:w-40 lg:w-44">
                </span> </h1>
            ...
            <p className="ml-6 text-xs mt-5 sm:text-center xl:mr-12">2024 @Personal Portfolio</p>
        </footer>
    )
}