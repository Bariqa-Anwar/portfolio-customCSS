...
export default function Contact(){
    return(
        <main>
            ...
            <h1 className="text-center text-blue-950 font-serif text-xl mt-12 mx-auto sm:text-3xl  lg:text-4xl 
            xl:text-5xl xl:mr-18"> 
            Contact <span className="block w-11 h-0.5 bg-red-500 mt-3 mx-auto xl:w-20">
            </span></h1> 
            </div>

            <div className="sm:flex flex-col md:ml-14 lg:ml-52 xl:ml-[350px]">
                <div className="container relative inline-block h-44 w-64 mx-auto shadow-lg bg-red-50 text-center mt-24 ml-5 mb-3
                ...
                <div className="container relative inline-block h-44 w-64 mx-auto shadow-lg mb-3 ml-5 bg-red-50 mt-5
                ...
                <br/>
                <Link className="ml-3 sm:ml-24" href="https://www.linkedin.com/in/bariqa-anwar-8767a02ba/" target="main">
                Stay connected here!</Link>
                    </div>
                    
                    <div className="container relative inline-block h-[480px] w-64 mx-auto shadow-lg mb-3 ml-5 bg-red-50
                    sm:ml-32 sm:w-96 sm:mt-6">
                        <h1 className="text-blue-950 font-serif text-xl mt-10 text-center md:text-2xl xl:text-3xl"> 
                        Get In Touch! 
                        <span className="block w-11 h-0.5 bg-red-500 mt-3 mx-auto"></span>   
                        </h1>
                    ...
                    <input className="border border-red-200 mt-5 ml-3 h-36 w-60 focus:outline-none focus:ring-2
                     focus:ring-red-400 placeholder:text-sm text-sm pb-28 pl-1 sm:w-72 sm:ml-11 md:w-80 md:ml-8 lg:placeholder:text-sm
                     xl:ml-3 xl:w-[350px]" 
                    ...
                    <div className="sm:text-center">
                        <p className="text-blue-950 text-2xl ml-5 mb-7 mt-5 font-serif sm:ml-20 sm:mr-20 md:ml-24 lg:ml-32 xl:mr-32 xl:text-3xl">
                        Message Me
                        <span className="block w-16 h-0.5 bg-red-500 mt-3 ml-4 sm:ml-48 sm:w-24 md:ml-60 lg:ml-[350px] xl:ml-[500px]">
                        </span>
                        </p>
                        <p className="text-gray-500 text-xs ml-4 mb-7 mr-5 sm:ml-32 sm:mr-28 md:ml-44 md:mr-44 
